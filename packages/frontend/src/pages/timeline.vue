    ...
    <MkSpacer :content-max="800">
      <div ref="rootEl" v-hotkey.global="keymap">
        ...
        <div v-if="queue > 0" :class="$style.new">
          <button class="_buttonPrimary" @click="top()">{{ i18n.ts.newNoteRecived }}</button>
        </div>
        <div :class="$style.tl">
          <MkTimeline ref="tlComponent" :key="src" :src="src" :sound="true" :hide-role="isDeck" @queue="queueUpdated" />
        </div>
      </div>
    </MkSpacer>
  </MkStickyContainer>
