    ...
    <FormSlot>
      <MkFolder>
        ...
        <div class="_gaps_m">
          ...
          <div>
            <MkButton :disabled="fields.length >= 50" inline style="margin-right: 8px" @click="addField"
    ...
    <MkFolder>
      ...
      <div class="_gaps_m">
        <MkSwitch v-model="profile.isCat"
          >{{ i18n.ts.flagAsCat }}<template #caption>{{ i18n.ts.flagAsCatDescription }}</template></MkSwitch
        >
        <MkSwitch v-model="profile.isBot"
          >{{ i18n.ts.flagAsBot }}<template #caption>{{ i18n.ts.flagAsBotDescription }}</template></MkSwitch
        >
      </div>
    </MkFolder>
