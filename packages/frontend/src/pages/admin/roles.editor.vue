      ...
      <div class="_gaps_s">
        ...
        <MkFolder v-if="matchQuery([i18n.ts._role._options.rateLimitFactor, 'rateLimitFactor'])">
          ...
          <div class="_gaps">
            ...
            <MkRange
              :model-value="role.policies.rateLimitFactor.value * 100"
              :min="0"
              :max="400"
              :step="10"
              :text-converter="(v) => `${v}%`"
              @update:model-value="(v) => (role.policies.rateLimitFactor.value = v / 100)"
            >
              <template #label>{{ i18n.ts._role._options.rateLimitFactor }}</template>
        ...
        <MkFolder v-if="matchQuery([i18n.ts._role._options.canNote, 'canNote'])">
          ...
          <template #suffix>
            <span v-if="role.policies.canNote.useDefault" :class="$style.useDefaultLabel">{{
              i18n.ts._role.useBaseValue
            }}</span>
          ...
          <div class="_gaps">
            ...
            <MkSwitch
              v-model="role.policies.canNote.value"
              :disabled="role.policies.canNote.useDefault"
              :readonly="readonly"
            >
              <template #label>{{ i18n.ts.enable }}</template>
            </MkSwitch>
            <MkRange
              v-model="role.policies.canNote.priority"
              :min="0"
              :max="2"
              :step="1"
              easing
        ...
        <MkFolder v-if="matchQuery([i18n.ts._role._options.canManageCustomEmojis, 'canManageCustomEmojis'])">
          ...
          <template #suffix>
            ...
            <span :class="$style.priorityIndicator"
              ><i :class="getPriorityIcon(role.policies.canManageCustomEmojis)"></i
            ></span>
          </template>
          <div class="_gaps">
        ...
        <MkFolder v-if="matchQuery([i18n.ts._role._options.suspendUponAccountDeletion, 'suspendUponAccountDeletion'])">
          <template #label>{{ i18n.ts._role._options.suspendUponAccountDeletion }}</template>
          <template #suffix>
            <span v-if="role.policies.suspendUponAccountDeletion.useDefault" :class="$style.useDefaultLabel">{{
              i18n.ts._role.useBaseValue
            }}</span>
            <span v-else>{{ role.policies.suspendUponAccountDeletion.value ? i18n.ts.yes : i18n.ts.no }}</span>
            <span :class="$style.priorityIndicator"
              ><i :class="getPriorityIcon(role.policies.suspendUponAccountDeletion)"></i
            ></span>
          </template>
          <div class="_gaps">
            <MkSwitch v-model="role.policies.suspendUponAccountDeletion.useDefault" :readonly="readonly">
              <template #label>{{ i18n.ts._role.useBaseValue }}</template>
            </MkSwitch>
            <MkSwitch
              v-model="role.policies.suspendUponAccountDeletion.value"
              :disabled="role.policies.suspendUponAccountDeletion.useDefault"
              :readonly="readonly"
            >
              <template #label>{{ i18n.ts.enable }}</template>
            </MkSwitch>
            <MkRange
              v-model="role.policies.suspendUponAccountDeletion.priority"
              :min="0"
              :max="2"
              :step="1"
              easing
        ...
        <MkFolder v-if="matchQuery([i18n.ts._role._options.userEachUserListsMax, 'userEachUserListsLimit'])">
          ...
          <template #suffix>
            ...
            <span :class="$style.priorityIndicator"
              ><i :class="getPriorityIcon(role.policies.userEachUserListsLimit)"></i
            ></span>
          </template>
          <div class="_gaps">
