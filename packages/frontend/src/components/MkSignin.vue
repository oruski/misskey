  ...
  <form class="eppvobhk" :class="{ signing, totpLogin }" @submit.prevent="onSubmit">
    <div class="auth _gaps_m">
      ...
      <div v-if="!totpLogin" class="normal-signin _gaps_m">
        ...
        <MkButton type="submit" large primary rounded :disabled="signing" style="margin: 0 auto">
      ...
      <div v-if="totpLogin" class="2fa-signin" :class="{ securityKeys: user && user.securityKeys }">
        ...
        <div class="twofa-group totp-group">
          ...
          <MkButton type="submit" :disabled="signing" large primary rounded style="margin: 0 auto">
            {{ signing ? i18n.ts.loggingIn : i18n.ts.login }}
          </MkButton>
        </div>
      </div>
...
function loginFailed(err) {
  switch (err.id) {
    ...
    case 'e03a5f46-d309-4865-9b69-56282d94e1eb': {
      showSuspendedDialog(err.reason);
      break;
    }
