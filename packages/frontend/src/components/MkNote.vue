  ...
  >
    ...
    <article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
      ...
      <div :class="$style.main">
        <MkNoteHeader :class="$style.header" :note="appearNote" :mini="true" :hide-role="props.hideRole" />
...
let renoteCollapsed = $ref(
  defaultStore.state.collapseRenotes && isRenote && (($i && $i.id === note.userId) || appearNote.myReaction != null),
);
...
function onContextmenu(ev: MouseEvent): void {
  ...
  if (defaultStore.state.useReactionPickerForContextMenu) {
    ...
    os.contextMenu(
      getNoteMenu({ note: note, translating, translation, menuButton, isDeleted, currentClipPage }),
      ev,
    ).then(focus);
  }
}
