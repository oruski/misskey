  ...
  <div :class="[$style.root, { [$style.withWallpaper]: wallpaper }]">
    ...
    <div v-if="isMobile" ref="navFooter" :class="$style.nav">
      ...
      <button
        ...
        class="_button"
        @click="mainRouter.currentRoute.value.name === 'index' ? top() : mainRouter.push('/')"
      >
      ...
      <button
        ...
        class="_button"
        @click="isMessagingRoom ? os.clickSendMessageButton() : os.post()"
      >
        <i :class="[$style.navButtonIcon, isMessagingRoom ? 'ti-send' : 'ti-pencil']" class="ti"></i>
      </button>
    </div>
...
const onContextmenu = (ev) => {
  ...
  if (
    ['INPUT', 'TEXTAREA', 'IMG', 'VIDEO', 'CANVAS'].includes(ev.target.tagName) ||
